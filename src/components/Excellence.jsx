...
const reasonsMeta = [
  { Icon: Stethoscope,   titleKey: 'exc_r1_title', descKey: 'exc_r1_desc' },
  { Icon: Syringe,       titleKey: 'exc_r2_title', descKey: 'exc_r2_desc' },
  { Icon: Leaf,          titleKey: 'exc_r3_title', descKey: 'exc_r3_desc' },
  { Icon: ClipboardText, titleKey: 'exc_r4_title', descKey: 'exc_r4_desc' },
]

const pillarsMeta = [
  { Icon: Dna,       titleKey: 'exc_p1_title', descKey: 'exc_p1_desc' },
  { Icon: PaintBrush, titleKey: 'exc_p2_title', descKey: 'exc_p2_desc' },
  { Icon: Plant,     titleKey: 'exc_p3_title', descKey: 'exc_p3_desc' },
]
          ...
          {reasonsMeta.map((r) => (
            <div key={r.titleKey} className="card-hover bg-white rounded-2xl p-7 shadow-sm border border-gray-100 text-center">
              <div className="w-16 h-16 bg-[#f0f7f4] rounded-2xl flex items-center justify-center mx-auto mb-5">
                <r.Icon className="w-8 h-8 text-[#2d5a4e]" weight="duotone" />
              </div>
          ...
          {pillarsMeta.map((p) => (
            <div key={p.titleKey} className="flex items-start gap-4 bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
              <div className="w-12 h-12 bg-[#2d5a4e]/10 rounded-xl flex items-center justify-center flex-shrink-0">
                <p.Icon className="w-6 h-6 text-[#2d5a4e]" weight="duotone" />
              </div>
              <div>
